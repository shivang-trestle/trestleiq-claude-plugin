...
export const phoneValidationInput = z.object({
  phone: phoneInput.describe(
    'US phone number. Accepts 10-digit (2069735100), E.164 (+12069735100), or formatted (415-555-2671). Normalized to 10 digits before sending.',
  ),
});
...
export const reversePhoneInput = z.object({
  phone: phoneInput.describe(
    'US phone number. Accepts 10-digit, E.164, or formatted. Normalized to 10 digits before sending.',
  ),
});
